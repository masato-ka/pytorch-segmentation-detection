...
class Endovis_Instrument_2017_fast(data.Dataset):
    ...
    def __init__(self,
        ...
        self.preloaded_img_anno_pairs = []
        
        for image_filename, annotations_filenames_dict in self.img_annotations_filenames_tuples:
            ...
            self.preloaded_img_anno_pairs.append((_img, final_annotation_numpy))
    ...
    def __getitem__(self, index):
        ...
        _img, final_annotation_numpy = self.preloaded_img_anno_pairs[index]
